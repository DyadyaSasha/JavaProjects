 ...
 * @since 1.0.18
 */
public interface TaMouseHandlerFX {
     ...
     */
    void handleMouseMoved(TaChartCanvas canvas, MouseEvent e);
     ...
     * @param e  the event ({@code null} not permitted).
     */
    void handleMouseClicked(TaChartCanvas canvas, MouseEvent e);
     ...
     * @param e  the event ({@code null} not permitted).
     */
    void handleMousePressed(TaChartCanvas canvas, MouseEvent e);
     ...
     * @param e  the event ({@code null} not permitted).
     */
    void handleMouseDragged(TaChartCanvas canvas, MouseEvent e);
     ...
     * @param e  the event ({@code null} not permitted).
     */
    void handleMouseReleased(TaChartCanvas canvas, MouseEvent e);
     ...
     * @param e  the event ({@code null} not permitted).
     */
    void handleScroll(TaChartCanvas canvas, ScrollEvent e);
