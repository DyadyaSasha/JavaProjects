 ...
 * @since 1.0.18
 */
public class TaZoomHandlerFX extends TaAbstractMouseHandlerFX {
     ...
     * @param parent  the org.sjwimmer.tacharting.chart viewer.
     */
    public TaZoomHandlerFX(String id, TaChartViewer parent) {
     ...
     */
    public TaZoomHandlerFX(String id, TaChartViewer parent, boolean altKey,
